...
💥 **Blog post** on [a bug in Fairseq](https://lydianishimwe.info/blog/fairseq-overwrite/) discovered during this project

💥 **RoLASER v2** on [Hugging Face](https://huggingface.co/lydianish/RoLASER-v2):
